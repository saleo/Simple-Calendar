...
data class Event(var id: Int = 0, var startTS: Int = 0, var endTS: Int = 0, var title: String = "", var description: String = "",
                 var reminder1Minutes: Int = REMINDER_INITIAL_MINUTES, var reminder2Minutes: Int = -1, var reminder3Minutes: Int = -1, var repeatInterval: Int = 0,
                 ...
                 var source: String = SOURCE_SIMPLE_CALENDAR, var color: Int = 0, var location: String = "",var syncUid:String="") : Serializable {
