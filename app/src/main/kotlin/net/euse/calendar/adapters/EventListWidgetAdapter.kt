...
import net.euse.calendar.R.id.event_item_holder
import net.euse.calendar.R.id.event_item_title
...
import net.euse.calendar.helpers.EVENT_OCCURRENCE_TS
        ...
        if (type == ITEM_EVENT) {
            ...
            remoteView = RemoteViews(context.packageName, R.layout.event_list_section_widget).apply {
                ...
                Intent().apply {
                    ...
                    setOnClickFillInIntent(event_item_title, this)
                }
            }
        }
