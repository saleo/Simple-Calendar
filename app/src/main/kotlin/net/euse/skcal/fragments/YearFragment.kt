...
import net.euse.skcal.helpers.YEAR_LABEL
import net.euse.skcal.helpers.YearlyCalendarImpl
import net.euse.skcal.interfaces.YearlyCalendar
import net.euse.skcal.models.DayYearly
import net.euse.skcal.views.SmallMonthView
...
class YearFragment : Fragment(), YearlyCalendar {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        mView = inflater.inflate(net.euse.skcal.R.layout.fragment_year, container, false)
    ...
    private fun setupMonths() {
        ...
        for (i in 1..12) {
            ...
            monthView.setOnClickListener {
                (activity as net.euse.skcal.activities.MainActivity).openMonthFromYearly(DateTime().withDate(mYear, i, 1))
            }
        }
    }
