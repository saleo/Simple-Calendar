...
import net.euse.skcal.extensions.getMonthCode
...
class MonthFragmentsHolder : MyFragmentHolder(), NavigationListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(net.euse.skcal.R.layout.fragment_months_holder, container, false)
    ...
    private fun setupFragment() {
        ...
        val monthlyAdapter = net.euse.skcal.adapters.MyMonthPagerAdapter(activity!!.supportFragmentManager, codes, this)
    ...
    override fun refreshEvents() {
        (viewPager?.adapter as? net.euse.skcal.adapters.MyMonthPagerAdapter)?.updateCalendars(viewPager?.currentItem ?: 0)
    }
