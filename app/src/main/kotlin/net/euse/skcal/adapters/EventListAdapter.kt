...
class EventListAdapter(activity: net.euse.skcal.activities.SimpleActivity, val listItems: ArrayList<ListItem>, val allowLongClick: Boolean, val listener: RefreshRecyclerViewListener?,
                       recyclerView: MyRecyclerView, itemClick: (Any) -> Unit) : MyRecyclerViewAdapter(activity, recyclerView, null, itemClick) {

    private val ITEM_EVENT = 0
    private val ITEM_HEADER = 1

    private val topDivider = resources.getDrawable(net.euse.skcal.R.drawable.divider_width)
    private val allDayString = resources.getString(net.euse.skcal.R.string.all_day)
    private val replaceDescriptionWithLocation = activity.config.replaceDescription
    private val redTextColor = resources.getColor(net.euse.skcal.R.color.red_text)
    ...
    override fun getActionMenuId() = net.euse.skcal.R.menu.cab_event_list
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): MyRecyclerViewAdapter.ViewHolder {
        val layoutId = if (viewType == ITEM_EVENT) net.euse.skcal.R.layout.event_list_item else net.euse.skcal.R.layout.event_list_section
