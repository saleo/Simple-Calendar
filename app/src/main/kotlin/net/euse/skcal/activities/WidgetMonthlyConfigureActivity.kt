...
import net.euse.skcal.helpers.LOW_ALPHA
import net.euse.skcal.helpers.MonthlyCalendarImpl
import net.euse.skcal.helpers.MyWidgetMonthlyProvider
...
class WidgetMonthlyConfigureActivity : net.euse.skcal.activities.SimpleActivity(), MonthlyCalendar {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(net.euse.skcal.R.layout.widget_config_monthly)
        initVariables()
