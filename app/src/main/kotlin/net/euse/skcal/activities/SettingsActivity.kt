...
import net.euse.skcal.helpers.FONT_SIZE_LARGE
import net.euse.skcal.helpers.FONT_SIZE_MEDIUM
import net.euse.skcal.helpers.FONT_SIZE_SMALL
...
class SettingsActivity : net.euse.skcal.activities.SimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(net.euse.skcal.R.layout.activity_settings)
        res = resources
    ...
    private fun setupManageEventTypes() {
        settings_manage_event_types_holder.setOnClickListener {
            startActivity(Intent(this, net.euse.skcal.activities.ManageEventTypesActivity::class.java))
        }
    }
    ...
    private fun showCalendarPicker() {
        ...
        net.euse.skcal.dialogs.SelectCalendarsDialog(this) {
            ...
            toast(net.euse.skcal.R.string.syncing)
            ...
            Thread {
                ...
                toast(net.euse.skcal.R.string.synchronization_completed)
            }.start()
        }
    }
    ...
    private fun setupDeleteAllEvents() {
        settings_delete_all_events_holder.setOnClickListener {
            ConfirmationDialog(this, messageId = net.euse.skcal.R.string.delete_all_events_confirmation) {
                Thread {
        ...
        settings_start_weekly_at_holder.setOnClickListener {
            ...
            RadioGroupDialog(this@SettingsActivity, items, config.startWeeklyAt) {
                if (it as Int >= config.endWeeklyAt) {
                    toast(net.euse.skcal.R.string.day_end_before_start)
                } else {
    ...
    private fun setupReminderSound() {
        val noRingtone = res.getString(net.euse.skcal.R.string.no_ringtone_selected)
        ...
        settings_reminder_sound_holder.setOnClickListener {
            Intent(RingtoneManager.ACTION_RINGTONE_PICKER).apply {
                ...
                putExtra(RingtoneManager.EXTRA_RINGTONE_TITLE, res.getString(net.euse.skcal.R.string.reminder_sound))
                ...
                if (resolveActivity(packageManager) != null)
                    ...
                    toast(net.euse.skcal.R.string.no_ringtone_picker)
                }
            }
        }
    }
    ...
    private fun updateSnoozeText() {
        settings_snooze_delay.text = res.getQuantityString(net.euse.skcal.R.plurals.by_minutes, config.snoozeDelay, config.snoozeDelay)
    }
    ...
    private fun setupDisplayPastEvents() {
        ...
        settings_display_past_events_holder.setOnClickListener {
            net.euse.skcal.dialogs.CustomEventReminderDialog(this, displayPastEvents) {
    ...
    private fun getDisplayPastEventsText(displayPastEvents: Int): String {
        return if (displayPastEvents == 0) {
            getString(net.euse.skcal.R.string.never)
        } else {
    ...
    private fun setupFontSize() {
        ...
        settings_font_size_holder.setOnClickListener {
            val items = arrayListOf(
                    RadioItem(FONT_SIZE_SMALL, res.getString(net.euse.skcal.R.string.small)),
                    RadioItem(FONT_SIZE_MEDIUM, res.getString(net.euse.skcal.R.string.medium)),
                    RadioItem(FONT_SIZE_LARGE, res.getString(net.euse.skcal.R.string.large)))
    ...
    private fun getFontSizeText() = getString(when (config.fontSize) {
        FONT_SIZE_SMALL -> net.euse.skcal.R.string.small
        FONT_SIZE_MEDIUM -> net.euse.skcal.R.string.medium
        else -> net.euse.skcal.R.string.large
    })
                ...
                if (uri == null) {
                    ...
                    try {
                        if ((uri as Uri).scheme == "file") {
                            uri = getFilePublicUri(File(uri.path), net.euse.skcal.BuildConfig.APPLICATION_ID)
                        }
