...
val letterIDs = intArrayOf(net.euse.skcal.R.string.sunday_letter, net.euse.skcal.R.string.monday_letter, net.euse.skcal.R.string.tuesday_letter, net.euse.skcal.R.string.wednesday_letter,
        net.euse.skcal.R.string.thursday_letter, net.euse.skcal.R.string.friday_letter, net.euse.skcal.R.string.saturday_letter)
