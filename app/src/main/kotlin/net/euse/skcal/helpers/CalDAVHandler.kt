...
import net.euse.skcal.extensions.scheduleCalDAVSync
...
class CalDAVHandler(val context: Context) {
    fun refreshCalendars(activity: net.euse.skcal.activities.SimpleActivity? = null, callback: () -> Unit) {
    ...
    fun getCalDAVCalendars(activity: net.euse.skcal.activities.SimpleActivity? = null, ids: String = ""): List<CalDAVCalendar> {
    ...
    private fun fetchCalDAVCalendarEvents(calendarId: Int, eventTypeId: Int, activity: net.euse.skcal.activities.SimpleActivity?) {
