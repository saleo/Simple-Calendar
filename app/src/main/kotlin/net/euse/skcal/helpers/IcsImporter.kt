...
class IcsImporter(val activity: net.euse.skcal.activities.SimpleActivity) {
    ...
    private fun tryAddCategories(categories: String, context: Context) {
        ...
        curEventType = if (eventId == -1) {
            val newTypeColor = if (curCategoryColor == -2) context.resources.getColor(net.euse.skcal.R.color.color_primary) else curCategoryColor
