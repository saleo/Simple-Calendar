...
class EditRepeatingEventDialog(val activity: net.euse.skcal.activities.SimpleActivity, val callback: (allOccurrences: Boolean) -> Unit) {
    var dialog: AlertDialog

    init {
        val view = (activity.layoutInflater.inflate(net.euse.skcal.R.layout.dialog_edit_repeating_event, null) as ViewGroup).apply {
