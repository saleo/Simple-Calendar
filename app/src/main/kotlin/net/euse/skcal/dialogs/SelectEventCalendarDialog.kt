...
import net.euse.skcal.helpers.STORED_LOCALLY_ONLY
...
class SelectEventCalendarDialog(val activity: Activity, val calendars: List<CalDAVCalendar>, val currCalendarId: Int, val callback: (id: Int) -> Unit) {
    ...
    init {
        val view = activity.layoutInflater.inflate(net.euse.skcal.R.layout.dialog_select_radio_group, null) as ViewGroup
        ...
        activity.dbHelper.getEventTypes {
            activity.runOnUiThread {
                ...
                addRadioButton(activity.getString(net.euse.skcal.R.string.store_locally_only), STORED_LOCALLY_ONLY, Color.TRANSPARENT)
                wasInit = true
    ...
    private fun addRadioButton(title: String, typeId: Int, color: Int) {
        val view = activity.layoutInflater.inflate(net.euse.skcal.R.layout.radio_button_with_color, null)
