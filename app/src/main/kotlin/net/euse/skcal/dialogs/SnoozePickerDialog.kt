...
class SnoozePickerDialog(val activity: net.euse.skcal.activities.SimpleActivity, val minutes: Int, val callback: (newMinutes: Int) -> Unit) {
    init {
        val view = (activity.layoutInflater.inflate(net.euse.skcal.R.layout.dialog_snooze_picker, null) as ViewGroup).apply {
